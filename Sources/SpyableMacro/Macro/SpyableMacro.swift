...
///
/// Additionally, if a `PreprocessorFlag` is passed as a `flag` parameter, this will be used to wrap the entire declaration in an preprocessor `IfConfigDeclSyntax`, to allow users to configure the exposure of their generated spies.
///
/// Example:
/// ```swift
/// @Spyable
...
private extension DeclSyntaxProtocol {
    /// - Returns: The preprocessor `flag` parameter that can be optionally provided as `@Spyable(flag:)`.
